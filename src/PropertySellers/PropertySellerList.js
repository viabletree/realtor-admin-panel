 ...
 const PropertyList = props => {
    ...
    <List {...props} >
       <Datagrid rowClick="show" className="listWrap">
            ...
            <TextField label="SellerName" source="seller_name" className={classes.descriptionText}/>
            <TextField label="Address" source="address" className={classes.descriptionText}/>
            <TextField label="TitleCompanyCloser" source="title_company_closer" className={classes.descriptionText}/>
            <NumberField label="AmountOfContract" source="amount_of_contract" />
            <BooleanField label="IsEarnestMoneyReceived" source="is_earnest_money_received" />
            <DateField label="EarnestMoneyReceivedDate" source="earnest_money_received_date" />
            <BooleanField label="IsContractToLender" source="is_contract_to_lender" />
            <DateField label="ContractToLenderDate" source="contract_to_lender_date" />
            <BooleanField label="IsHomeWarranty" source="is_home_warranty" />
            <DateField label="HomeWarrantyDate" source="home_warranty_date" />
            <BooleanField label="IsSurveyReceived" source="is_survey_received" />
            <BooleanField label="IsNewSurvey" source="is_new_survey" />
            {/* <DateField label="SurveyDueDate" source="survey_due_date" /> */}
            <TextField label="NewSurveyInfo" source="new_survey_info" className={classes.descriptionText}/>
            <DateField label="HomeInspectionDate" source="home_inspection_date" />
            <TextField label="HomeInspectionInfo" source="home_inspection_info" className={classes.descriptionText}/>
            <DateField label="TermiteInspectionDate" source="termite_inspection_date" />
            ...
            <TextField label="AppraisalAdditionalInfo" source="appraisal_additional_info" className={classes.descriptionText}/>
            <BooleanField label="IsCdaSent" source="is_cda_sent" />
            <BooleanField label="IsSwitchOverUtilities" source="is_switch_over_utilities" />
            <DateField label="OptionPeriodEndDate" source="option_period_end_date" />
